    ...
    <>
      <Center pb={150}>
        <VStack spacing={25} mx={150} align="center">
          ...
          <Hide below="lg">
            <HStack align="center" justify="center" spacing={150} pt={75}>
              <Container>
                <Center pb={25}>
                ...
                <Text align="center" pt={25} mx={15}>
                  Kumiko's Economy is designed to scale, just like your empire.
                  Go ahead and sell on the marketplace!
                </Text>
              </Container>
              <Container>
                <Center pb={25}>
              ...
              <Container>
                ...
                <Text align="center" pt={25} mx={15}>
                  Kumiko is also completely free, and compared to MEE6 and
                  Probot and other bots, it's completely open source and free
                </Text>
              </Container>
            </HStack>
          </Hide>
          ...
          <Show below="lg">
            <VStack align="center" justify="center" spacing={150} pt={75}>
              <Container>
                <Center pb={25}>
                  <GiTakeMyMoney size={50} style={{ color: "#cccccc" }} />
                </Center>
